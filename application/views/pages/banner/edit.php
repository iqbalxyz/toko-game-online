<div class="container">
	...
	<div class="row bg-light p-3 mt-4">
		<div class="col">
			...
			<?= form_open_multipart(base_url('banner/edit/' . $spanduk['id'])) ?>
				<input type="hidden" name="id" value="<?= $spanduk['id'] ?>">
				<div class="form-group row">
					<label class="col-sm-2 col-form-label font-weight-bold">Judul Banner</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="judul" value="<?= $spanduk['judul'] ?>">
						<?= form_error('judul', '<small class="form-text text-danger">', '</small>') ?>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-2 col-form-label font-weight-bold">Konten Banner</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="konten" value="<?= $spanduk['konten'] ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select class="form-control" name="warna_text">
				...
				<div class="form-group row">
					<label class="col-sm-2 col-form-label font-weight-bold">Gambar Banner</label>
					<br>
					<div class="col-sm-10">
						<?php if(!empty($spanduk['gambar'])) : ?>
							<img src="<?= base_url('images/banner/'. $spanduk['gambar']) ?>" width="300">
						<?php else: ?>
							No Image
						<?php endif; ?>
						<br> <br>
