<nav class="navbar navbar-expand-lg navbar-light bg-light">
	<div class="container">
		<a class="navbar-brand" href="<?= base_url('home') ?>">
			<img src="<?= base_url() ?>images/logo/logo1.png" width="180" height="57" class="d-inline-block align-top" alt="logo" loading="lazy">
		</a>
				...
				<?php if($this->session->login == TRUE) : ?>
					...
					<?php else : ?>
						<li class="nav-item dropdown">
							...
							<a class="dropdown-item" href="<?= base_url('banner') ?>">Spanduk</a>
								<a class="dropdown-item" href="<?= base_url('product') ?>">Produk</a>
								<a class="dropdown-item" href="<?= base_url('order') ?>">Pesanan</a>
